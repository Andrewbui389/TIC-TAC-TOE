...
let checkWinner = () => {
    ...
    for(let i = 0; i<3;i++){
        ...
        if(gameArray.gameboard[i][i]===gameArray.gameboard[i][i] && gameArray.gameboard[i][i] === "x" ){
            acrossCountX++
        }else if(gameArray.gameboard[i][i]===gameArray.gameboard[i][i] && gameArray.gameboard[i][i] === "o"){
            acrossCount0++
        }
}
        for(let i = 3; i>0;i--){
